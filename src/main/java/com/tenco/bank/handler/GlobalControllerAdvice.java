...
public class GlobalControllerAdvice {
	...
	/**
	 * (개발시에 많이 활용) 모든 예외 클래스를 알 수 없기 때문에 로깅으로 확인할 수 있도록 설정 로깅처리 - 동기적 방식
	 * (System.out.println), @slf4j (비동기 처리 됨)
	 */
	...
	// 단, @ControllerAddvice를 사용하고 있다면 @ResponseBody 를 붙여서 사용하면 된다.
	@ResponseBody
	...
	/*
	 * 에러 페이지로 이동 처리 JSP로 이동시 데이터를 담아서 보내는 방법 ModelAndView, Model 사용가능 throw new
	 * RedirectException('페이지 없는디??', 404)
	 */
